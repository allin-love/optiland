...
def test_get_object_position_finite_object():
    ...
    y, z = lens.paraxial.ray_tracer._get_object_position(Hy=0, y1=0, EPL=-5)
    ...
    y, z = lens.paraxial.ray_tracer._get_object_position(Hy=1, y1=0, EPL=-5)
    assert z.item() == -10
    assert y.item() == -14
...
def test_invalid_object_position_call():
    ...
    with pytest.raises(ValueError):
        lens.paraxial.ray_tracer._get_object_position(Hy=0, y1=0, EPL=5)
